...
public class MinMaxAveShowingDialog {
	...
	public MinMaxAveShowingDialog(Shell shell, Clipboard clipboard_, int countOfValues) {
		...
		shellC = new Shell(shell, SWT.DIALOG_TRIM | SWT.PRIMARY_MODAL);
		{
			...
			gridLayout.numColumns = 4; // name, min, ave, max
